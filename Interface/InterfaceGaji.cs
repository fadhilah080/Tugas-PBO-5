...
namespace InterfaceGaji
{
    class Program
    {
        public abstract class Pegawai
        {
            ...
            public Pegawai(string Depan, string Belakang, string nomorktp)
            {
                NamaDepan = Depan;
        ...
        public class GajiKaryawan : Pegawai
        {
        ...
        public class PayrollSystemTest
        {
            static void Main(string[] args)
            {
                ...
                Pegawai[] karyawan = new Pegawai[4];
                ...
                foreach (Pegawai karyawanSekarang in karyawan)
                {
